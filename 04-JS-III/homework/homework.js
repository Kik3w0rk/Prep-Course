...
function promedioResultadosTest(resultadosTest) {
  ...
  respuesta=suma/resultadosTest.length;
  return respuesta;
}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
  semana=["","Es fin de semana","Es dia Laboral","Es dia Laboral","Es dia Laboral","Es dia Laboral","Es dia Laboral","Es fin de semana"];
